...
url = "https://www.house.kg/kupit-kommercheskaia-nedvijimost?commercial_type=2&region=all&sort_by=upped_at+desc&page={}"
...
def kir_office_sale():
    ...
    print("Scraping kir_office_sale completed successfully.")
    return results
